...
public class Battleship extends JFrame {
	...
	/**
	 * Construct a statically sized Battleship grid wrapper
	 */
	public Battleship() {
		setResizable(false);
		setTitle("Battleship");
...
//					}
	...
	/**
	 * 
	 * The main method of the program which runs the battleship game
	 * 
	 * @param args 
	 */
	public static void main(String[] args) {
		...
		// Initialize a Battleship object and set default behavior
